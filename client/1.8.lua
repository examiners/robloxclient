...
run(function()
	...
	info.Size = UDim2.new(1, -16, 0, 80)
	info.BackgroundTransparency = 1
	info.Text = 'Loaded for the 1.8 game.'
	...
	inputService.InputBegan:Connect(function(input, processed)
		...
		if input.KeyCode == Enum.KeyCode.RightShift and not inputService:GetFocusedTextBox() then
